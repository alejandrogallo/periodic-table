...
\node[below of=Np, name=details, DetailsLabel]{Standard atomic masses taken from Comission on Isotopic Abundances and Atomic Weights (http://www.ciaaw.org/atomic-weights.htm). \\ Adapted from Ivan Griffin's \LaTeX\space Periodic Table. \textcopyright\space \the\year\space Paul Danese};
\end{tikzpicture}
\end{document}