...
%% Group 1 - IA
  ...
  \node[name=H,below of=Blank2, Element] {\NaturalElementTextFormat{1}{1.00794}{H}{Hydrogen}};
  \node[name=Li, below of=H, Element] {\NaturalElementTextFormat{3}{6.941}{Li}{Lithium}};
...
%% Group 2 - IIA
  ...
  \node[name=Mg, below of=Be, Element] {\NaturalElementTextFormat{12}{24.305}{Mg}{Magnesium}};
...
%% Group 13 - IIIA
  ...
  \node[name=B, above of=Al, Element] {\NaturalElementTextFormat{5}{10.81}{B}{Boron}};
  \node[name=In, below of=Ga, Element] {\NaturalElementTextFormat{49}{114.818(1)}{In}{Indium}};
  \node[name=Tl, below of=In, Element] {\NaturalElementTextFormat{81}{204.38}{Tl}{Thallium}};
  \node[name=Uut, below of=Tl, Element] {\NaturalElementTextFormat{113}{(286)}{Uut}{Ununtrium}};

%% Group 14 - IVA
  \node[name=C, right of=B, Element] {\NaturalElementTextFormat{6}{12.011}{C}{Carbon}};
  \node[name=Si, below of=C, Element] {\NaturalElementTextFormat{14}{28.085}{Si}{Silicon}};
...
%% Group 15 - VA
  \node[name=N, right of=C, Element] {\NaturalElementTextFormat{7}{14.007}{N}{Nitrogen}};
...
%% Group 16 - VIA
  \node[name=O, right of=N, Element] {\NaturalElementTextFormat{8}{15.999}{O}{Oxygen}};
  \node[name=S, below of=O, Element] {\NaturalElementTextFormat{16}{32.06}{S}{Sulphur}};
...
%% Group 17 - VIIA
  ...
  \node[name=Cl, below of=F, Element] {\NaturalElementTextFormat{17}{35.45}{Cl}{Chlorine}};
  \node[name=Br, below of=Cl, Element] {\NaturalElementTextFormat{35}{79.904}{Br}{Bromine}};
...
\node[below of=Np, name=details, DetailsLabel]{Standard atomic masses taken from Commission on Isotopic Abundances and Atomic Weights (\url{http://www.ciaaw.org/atomic-weights.htm}). \\ Adapted from Ivan Griffin's \LaTeX\space Periodic Table. \textcopyright\space \the\year\space Paul Danese};
\end{tikzpicture}
\end{document}